...
NB_vect_filename = 'vectorizerNB.pkl'
NB_vect_file = open(NB_vect_filename,'wb')
pickle.dump(vectorize, NB_vect_file)
...
print('Accuracy Score on the test data [Naive Bias] :', test_data_accuracy)
#75%
"""
